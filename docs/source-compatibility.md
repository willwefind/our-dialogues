...
| Personal Archive v1 (personal writing: diaries, dreams, essays, microblogs, notes, letters, fragments) | Yes | No | Archival entry text carried byte-for-byte as one document-mode message; provenance-aware title fallback; dates never invented | Not present in the format | Not in v1 (text-first) | Implemented and regression-tested; contract in [personal-archive-v1.md](personal-archive-v1.md), conversion guide in [bring-your-personal-archive.zh-CN.md](bring-your-personal-archive.zh-CN.md) |
